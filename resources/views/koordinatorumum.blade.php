...
<div class="font-inter">
    ...
    <section class="py-14 lg:py-24 ">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-24">
                <h2 class="font-manrope text-4xl text-center font-bold text-gray-900 mb-6 dark:text-white">Koordinator Umum
                </h2>
                <p class="text-lg text-gray-500 text-center dark:text-white">Pesona Anak Bangsa</p>
            </div>
            <!--Slider Wrapper-->
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div
                            ...
                            <div class=" w-full lg:w-48 h-64">
                                <img src="images/pembimbing.png" alt="image"
                            ...
                            <div class="text-center lg:text-left lg:max-w-xs flex-1">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    <h6 class="text-lg text-gray-900 font-semibold mb-1 dark:text-white">Ibu Ulfah Muhayani, MPP</h6>
                                    <span class="text-sm text-gray-500 group-hover:text-indigo-600">Pembimbing</span>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div
                            ...
                            <div class=" w-full lg:w-48 h-64 max-lg:max-w-[204px] max-lg:mx-auto">
                                <img src="images/ketua.png" alt="image"
                                    class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
                            </div>
                            <div class="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    <h6 class="text-lg text-gray-900 font-semibold mb-1">Manyingarri Alfianoor Ibrahim
                                    </h6>
                                    <span class="text-sm text-gray-500 group-hover:text-indigo-600">Ketua</span>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div
                            class="group w-full flex-wrap flex items-center gap-8  transition-all duration-500 p-8  lg:flex-nowrap">
                            <div class=" w-full lg:w-48 h-64">
                                <img src="images/sekretaris.png" alt="image"
                                    class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
                            </div>
                            <div class="text-center lg:text-left lg:max-w-xs flex-1">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    <h6 class="text-lg text-gray-900 font-semibold mb-1 dark:text-white">Atief Aisyil Wi’am</h6>
                                    <span class="text-sm text-gray-500 group-hover:text-indigo-600 dark:text-white">Sekretaris</span>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div
                            class="group w-full flex-wrap flex items-center gap-8 flex-col md:flex-row transition-all duration-500 p-8 lg:flex-nowrap">
                            <div class=" w-full lg:w-48 h-64 max-lg:max-w-[204px] max-lg:mx-auto">
                                <img src="images/bendahara.png" alt="image"
                                    class="rounded-2xl h-full object-cover mx-auto lg:mx-0 lg:w-full">
                            </div>
                            <div class="text-center lg:text-left lg:max-w-xs flex-1 flex flex-col justify-between">
                                <div class="mb-5 pb-5 border-b border-solid border-gray-300">
                                    <h6 class="text-lg text-gray-900 font-semibold mb-1 dark:text-white">Dinda Nur Maulid</h6>
                                    <span class="text-sm text-gray-500 group-hover:text-indigo-600 dark:text-white">Bendahara</span>
                                </div>
